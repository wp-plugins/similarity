...
Tags: posts, tags, categories, related
...
The plugin does not allow for similarity to be calculated on a combination of tags and plugins (at least in the current version), but you can use the sim-by-tag(); and sim_by_cat(); commands together to generate different lists of related posts.
